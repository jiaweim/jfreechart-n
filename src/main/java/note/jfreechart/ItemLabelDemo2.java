...
public class ItemLabelDemo2 extends ApplicationFrame {
    ...
    static class LabelGenerator extends AbstractCategoryItemLabelGenerator
        ...
        /**
         * Creates a new label generator that displays the item value and a percentage relative to the value in the same
         * series for the specified category.
         *
        ...
        /**
         * Creates a new label generator that displays the item value and a percentage relative to the value in the same
         * series for the specified category.  If the category index is <code>null</code>, the total of all items in the
         * series is used.
         *
        ...
        /**
         * Generates a label for the specified item. The label is typically a formatted version of the data value, but
        ...
        public String generateLabel(CategoryDataset dataset,
            ...
            if (value != null) {
                ...
                result = value + " (" + this.formatter.format(v / base) + ")";
            }
            return result;
    ...
    private static JFreeChart createChart(CategoryDataset dataset) {
        ...
        renderer.setDefaultItemLabelGenerator(new LabelGenerator(null));
