...
/**
 * A demo for SVG output of a time series chart. Running this application will
 * save a file {@code SVGTimeSeriesChartDemo1.svg} to the filesystem - you can
 * open this file in a browser to see the resulting chart.
 */
public class SVGTimeSeriesChartDemo1 {
	...
	private static JFreeChart createChart(XYDataset dataset) {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart("International Coffee Organisation : Coffee Prices", null,
				"US cents/lb", dataset);
