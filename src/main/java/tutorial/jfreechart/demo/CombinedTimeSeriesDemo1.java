...
/**
 * A demo showing a combined time series chart where one of the subplots is an overlaid
 * chart.
 */
public class CombinedTimeSeriesDemo1 extends ApplicationFrame {
    ...
    public static JPanel createDemoPanel() {
        ...
        TimeSeries series1 = new TimeSeries("Annual", Year.class);
        ...
        // create dataset 2...
        TimeSeries series2A = new TimeSeries("Monthly A", Month.class);
        ...
        TimeSeries series2B = new TimeSeries("Monthly B", Month.class);
        ...
        // create dataset 3...
        TimeSeries series3 = new TimeSeries("XXX", Month.class);
    ...
    public static void main(String[] args) {
        ...
        CombinedTimeSeriesDemo1 demo = new CombinedTimeSeriesDemo1("Combined Time Series Demo");
        demo.pack();
